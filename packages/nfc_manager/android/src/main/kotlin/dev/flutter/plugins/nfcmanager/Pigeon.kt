...
private fun deepEqualsPigeon(a: Any?, b: Any?): Boolean {
  ...
  if (a is Array<*> && b is Array<*>) {
    return a.size == b.size &&
        a.indices.all{ deepEqualsPigeon(a[it], b[it]) }
  }
  if (a is Map<*, *> && b is Map<*, *>) {
    return a.size == b.size && a.keys.all {
        (b as Map<Any?, Any?>).containsKey(it) &&
        deepEqualsPigeon(a[it], b[it])
    }
  }
  return a == b;
}
...
data class TagPigeon (
...
)
 {
  ...
  override fun equals(other: Any?): Boolean {
    ...
    && deepEqualsPigeon(id, other.id)
    && deepEqualsPigeon(techList, other.techList)
    && ndef == other.ndef
    && nfcA == other.nfcA
    && nfcB == other.nfcB
    && nfcF == other.nfcF
...
data class NfcAPigeon (
...
)
 {
  ...
  override fun equals(other: Any?): Boolean {
    ...
    return deepEqualsPigeon(atqa, other.atqa)
    && sak == other.sak
  }
...
data class NfcBPigeon (
...
)
 {
  ...
  override fun equals(other: Any?): Boolean {
    ...
    return deepEqualsPigeon(applicationData, other.applicationData)
    && deepEqualsPigeon(protocolInfo, other.protocolInfo)
  }
...
data class NfcFPigeon (
...
)
 {
  ...
  override fun equals(other: Any?): Boolean {
    ...
    return deepEqualsPigeon(manufacturer, other.manufacturer)
    && deepEqualsPigeon(systemCode, other.systemCode)
  }
...
data class IsoDepPigeon (
...
)
 {
  ...
  override fun equals(other: Any?): Boolean {
    ...
    return deepEqualsPigeon(hiLayerResponse, other.hiLayerResponse)
    && deepEqualsPigeon(historicalBytes, other.historicalBytes)
...
data class NfcBarcodePigeon (
...
)
 {
  ...
  override fun equals(other: Any?): Boolean {
    ...
    return type == other.type
    && deepEqualsPigeon(barcode, other.barcode)
  }
...
data class NdefMessagePigeon (
...
)
 {
  ...
  override fun equals(other: Any?): Boolean {
    ...
    return deepEqualsPigeon(records, other.records)
  }
...
data class NdefRecordPigeon (
...
)
 {
  ...
  override fun equals(other: Any?): Boolean {
    ...
    && deepEqualsPigeon(type, other.type)
    && deepEqualsPigeon(id, other.id)
    && deepEqualsPigeon(payload, other.payload)
  }
