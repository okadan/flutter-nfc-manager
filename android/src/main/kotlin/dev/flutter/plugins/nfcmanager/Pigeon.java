...
public class Pigeon {
  ...
  public enum PigeonMifareClassicType {
    CLASSIC(0),
    PLUS(1),
    PRO(2),
    UNKNOWN(3);
    ...
    private PigeonMifareClassicType(final int index) {
      this.index = index;
    }
  }

  public enum PigeonMifareUltralightType {
    ULTRALIGHT(0),
    ULTRALIGHT_C(1),
    UNKNOWN(2);
    ...
    private PigeonMifareUltralightType(final int index) {
      this.index = index;
    }
  }
  ...
  public static final class PigeonMifareClassic {
    private @Nullable PigeonMifareClassicType type;

    public @Nullable PigeonMifareClassicType getType() {
      return type;
    }

    public void setType(@Nullable PigeonMifareClassicType setterArg) {
      this.type = setterArg;
    }
    ...
    public static final class Builder {
      ...
      public @NonNull Builder setType(@Nullable PigeonMifareClassicType setterArg) {
        this.type = setterArg;
        return this;
      }
    ...
    static @NonNull PigeonMifareClassic fromList(@NonNull ArrayList<Object> list) {
      ...
      Object type = list.get(0);
      pigeonResult.setType(type == null ? null : PigeonMifareClassicType.values()[(int) type]);
  ...
  public static final class PigeonMifareUltralight {
    private @Nullable PigeonMifareUltralightType type;

    public @Nullable PigeonMifareUltralightType getType() {
      return type;
    }

    public void setType(@Nullable PigeonMifareUltralightType setterArg) {
      this.type = setterArg;
    }
    ...
    public static final class Builder {
      ...
      public @NonNull Builder setType(@Nullable PigeonMifareUltralightType setterArg) {
        this.type = setterArg;
        return this;
      }
    ...
    static @NonNull PigeonMifareUltralight fromList(@NonNull ArrayList<Object> list) {
      ...
      Object type = list.get(0);
      pigeonResult.setType(type == null ? null : PigeonMifareUltralightType.values()[(int) type]);
      return pigeonResult;
    }
  }
  ...
  public static class PigeonFlutterApi {
    ...
    public PigeonFlutterApi(@NonNull BinaryMessenger argBinaryMessenger) {
    ...
    public void onTagDiscovered(@NonNull PigeonTag tagArg, @NonNull Reply<Void> callback) {
    ...
    public void onAdapterStateChanged(@NonNull Long stateArg, @NonNull Reply<Void> callback) {
      BasicMessageChannel<Object> channel =
          new BasicMessageChannel<>(
  ...
  public interface PigeonHostApi {
    ...
    void adapterEnableReaderMode(@NonNull List<String> flags);
    ...
    @NonNull 
    byte[] nfcATransceive(@NonNull String handle, @NonNull byte[] bytes);

    @NonNull 
    Long nfcBGetMaxTransceiveLength(@NonNull String handle);

    @NonNull 
    byte[] nfcBTransceive(@NonNull String handle, @NonNull byte[] bytes);
    ...
    @NonNull 
    byte[] nfcFTransceive(@NonNull String handle, @NonNull byte[] bytes);

    @NonNull 
    Long nfcVGetMaxTransceiveLength(@NonNull String handle);

    @NonNull 
    byte[] nfcVTransceive(@NonNull String handle, @NonNull byte[] bytes);
    ...
    @NonNull 
    byte[] isoDepTransceive(@NonNull String handle, @NonNull byte[] bytes);
    ...
    @NonNull 
    byte[] mifareClassicTransceive(@NonNull String handle, @NonNull byte[] bytes);
    ...
    @NonNull 
    byte[] mifareUltralightTransceive(@NonNull String handle, @NonNull byte[] bytes);
    ...
    static void setup(@NonNull BinaryMessenger binaryMessenger, @Nullable PigeonHostApi api) {
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
        ...
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ...
                List<String> flagsArg = (List<String>) args.get(0);
                try {
        ...
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ...
                try {
                  byte[] output = api.nfcATransceive(handleArg, bytesArg);
                  wrapped.add(0, output);
                }
 catch (Throwable exception) {
                  ArrayList<Object> wrappedError = wrapError(exception);
        ...
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ...
                byte[] bytesArg = (byte[]) args.get(1);
                try {
                  byte[] output = api.nfcBTransceive(handleArg, bytesArg);
                  wrapped.add(0, output);
                }
 catch (Throwable exception) {
                  ArrayList<Object> wrappedError = wrapError(exception);
        ...
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ...
                byte[] bytesArg = (byte[]) args.get(1);
                try {
                  byte[] output = api.nfcFTransceive(handleArg, bytesArg);
                  wrapped.add(0, output);
                }
 catch (Throwable exception) {
                  ArrayList<Object> wrappedError = wrapError(exception);
        ...
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ...
                byte[] bytesArg = (byte[]) args.get(1);
                try {
                  byte[] output = api.nfcVTransceive(handleArg, bytesArg);
                  wrapped.add(0, output);
                }
 catch (Throwable exception) {
                  ArrayList<Object> wrappedError = wrapError(exception);
        ...
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ...
                byte[] bytesArg = (byte[]) args.get(1);
                try {
                  byte[] output = api.isoDepTransceive(handleArg, bytesArg);
                  wrapped.add(0, output);
                }
 catch (Throwable exception) {
                  ArrayList<Object> wrappedError = wrapError(exception);
        ...
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ...
                byte[] bytesArg = (byte[]) args.get(1);
                try {
                  byte[] output = api.mifareClassicTransceive(handleArg, bytesArg);
                  wrapped.add(0, output);
                }
 catch (Throwable exception) {
                  ArrayList<Object> wrappedError = wrapError(exception);
        ...
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ...
                byte[] bytesArg = (byte[]) args.get(1);
                try {
                  byte[] output = api.mifareUltralightTransceive(handleArg, bytesArg);
                  wrapped.add(0, output);
                }
 catch (Throwable exception) {
                  ArrayList<Object> wrappedError = wrapError(exception);
